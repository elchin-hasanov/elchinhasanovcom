...
function Timeline({ mounted }) {
  ...
  const items = [
    {
      ...
      desc: [
        "Built a data infrastructure for real-time monitoring of trading activity in Python/Django + PostgreSQL, streaming multi-GB order-book feeds via Redis; reduced query latency from 90 s to 4.7 s and scaled throughput 20× to support 10K+ req/min.",
        "Engineered Next.js + TypeScript dashboards with WebSocket channels, enabling tick-level visualization of liquidity, VPIN, and volatility metrics accessed by 15+ analysts daily.",
        "Orchestrated containerized microservices using Docker on AWS EC2, integrated GitHub Actions CI/CD, and automated anomaly detection + metric logging, reducing ops overhead by 40% and increasing system uptime to 99.8%.",
      ],
  tech: ["Python","Django","PostgreSQL","Redis","Next.js","TypeScript","AWS","Docker"],
    },
    {
      type: "experience",
      title: "Software Engineering Intern",
      org: "Agrarian Insurance Fund",
      location: "Baku, Azerbaijan",
      date: "Jun 2023 – Aug 2023",
      desc: [
        "Designed a geospatial ETL pipeline combining climate APIs, satellite imagery, and claims data in PostgreSQL/PostGIS, processing 100K+ data points across 12+ regions for polygon-level drought and soil-index analytics.",
        "Integrated asynchronous Django services with Celery and Firebase Cloud Messaging, sustaining under 2 s P95 latency and handling 5× higher throughput for actuarial risk scoring and policy updates.",
        "Launched a multi-model ensemble (XGBoost DART, ExtraTrees, Stacked Logistic Regression) for drought and claim-risk scoring; used SHAP for automated retraining via AWS Batch + Docker, reducing claim-resolution time by 85%.",
      ],
  tech: ["Python","Django","PostgreSQL","PostGIS","Celery","Firebase","XGBoost","SHAP","AWS","Docker"],
    },
    {
      type: "research",
  title: "Undergraduate Researcher — Predictive Analytics in Recruitment",
      ...
      desc: [
        "Co-authored a cross-disciplinary study with Social Sciences & Computer Science departments, applying ensemble learning to forecast hiring outcomes and reduce bias across a 60K-record Kaggle dataset of candidate qualifications and performance metrics.",
        "Built and optimized Random Forest, AdaBoost, and Gradient Boosting pipelines in Python (scikit-learn + Optuna) with 5-fold CV, achieving +29% predictive lift and −22% false-positive rate over baseline classifiers; leveraged GridSearch + early stopping for convergence.",
        "Deployed feature-importance and SHAP analysis to surface latent bias patterns and interpret feature interactions, producing explainable insights that informed conference-published results on fairness-aware recruitment systems presented to 200+ researchers.",
      ],
  tech: ["Python","scikit-learn","Optuna","GridSearch","SHAP"],
    },
    {
      type: "research",
      title: "Undergraduate Researcher — Hybrid Sequence Models",
      org: "Georgia Institute of Technology",
      location: "Atlanta, GA",
      date: "May 2025 – Present",
      desc: [
        "Exploring Mamba state-space models (SSMs) combined with Transformer attention; constructed custom TensorFlow blocks with gated routing and residual mixing, lowering FLOPs by 22%.",
        "Benchmarked models on 64K-token inputs using FlashAttention v2 and DeepSpeed/FSDP; achieved 1.6× faster training and 18% lower GPU memory usage.",
        "Conducted ablations on state size, convolution span, and skip connections; evaluated across 3+ large-scale datasets (WikiText, The Pile, financial filings).",
        "Results show 28% lower inference cost vs. baseline Transformers; preparing a first-author submission to ICLR 2026.",
      ],
  tech: ["TensorFlow","FlashAttention","DeepSpeed","FSDP"],
    },
    {
      type: "research",
      title: "Undergraduate Researcher — Conference Trend Mining",
      org: "Georgia Institute of Technology",
      location: "Atlanta, GA",
      date: "Jul 2025 – Present",
      desc: [
        "Built a conference intelligence platform scraping 20K+ papers and event pages using Playwright + asyncio; parsed 5+ GB of metadata and stored structured data in PostgreSQL.",
        "Applied BERTopic with SentenceTransformers + HDBSCAN to detect 120+ topic clusters of emerging research; added FAISS-based merging to unify overlapping areas.",
        "Created a jargon-simplification pipeline: GPT-4 extracts key claims, expands acronyms, and RoBERTa-MNLI validates consistency, improving summary readability by 35%.",
        "Designed a Streamlit dashboard with insights and interactive Plotly charts tracking trends across 10+ conferences since 2020.",
      ],
  tech: ["Playwright","asyncio","PostgreSQL","BERTopic","SentenceTransformers","HDBSCAN","FAISS","RoBERTa","Streamlit","Plotly"],
    },
  ];
